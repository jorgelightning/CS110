...
def readFileDictionary(fileEmpty):
    contacts= {}
...
contacts = readFileDictionary(fileEmpty)


while(exit != 1):
    while True:
        try:
            userAction = int(input('Contacts management program\n\n(1)Add a new entry\n(2)Change the phone number\n(3)Delete an entry\n(4)Display the contacts list\n(5)Exit the program\n\nWhat would you like to do: '))
    ...
    if(userAction == 1):
        userName = str(input('What is the name would you like to add: '))
        userNumber = str(input('What is the number would you like to add: '))
        contacts[userName] = userNumber

    if(userAction == 2):
        findName = str(input('What is the contact name would you like to change: '))
    ...
    if(userAction == 3):
        delName = str(input('What contact would you like to del: ')) 
